                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $ds->nama_layanan }}</td>
                                                <td>{{ $ds->deskripsi_layanan }}</td>
                                                <td class="text-center">{{ 'Rp. '.number_format($ds->harga_layanan, 2, ',', '.') }}</td>
                                                <td class="text-center">
                                                    <a href="{{ url('/update/data/service/id/'.$ds->id) }}">
                                                        <button class="btn btn-primary">Ubah</button>
                                                    </a>
                                                    <a href="{{ url('/delete/data/service/id/'.$ds->id) }}">
