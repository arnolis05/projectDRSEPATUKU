                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card mt-3">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('/proses/new/service') }}" enctype="multipart/form-data" method="post">
                                            @csrf()
                                            @method('get')
                                            <div class="form-group">
                                                <label class="control-label mb-1">Nama Layanan <span class="text-danger">*</span></label>
                                                <input name="nama_layanan" type="text" class="form-control" aria-required="true">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label mb-1">Deskripsi <span class="text-danger">*</span></label>
                                                <textarea name="deskripsi_layanan" type="text" class="form-control" aria-required="true"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label mb-1">Harga <span class="text-danger">*</span></label>
                                                <input name="harga_layanan" type="text" class="form-control" aria-required="true">
                                            </div>
